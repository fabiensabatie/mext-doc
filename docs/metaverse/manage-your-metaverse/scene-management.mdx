...
The Scene Management feature is exclusively available in the **Professional** and **Custom Metaverse** packages, designed for those with multiple scenes. To add a new scene, simply click on the "Add a scene" button.
