...
\
In the "Principal Information" section, you can provide the following details:

* **Metaverse name**: Specify the name of your metaverse.
* **Type**: Choose whether it should be private or public. Select "public" if you want everyone to have access, or "private" if access should be limited to those who receive a specific link from you. Privacy can also be useful during the development stage when the metaverse is not yet ready to be viewed.
* **Start/End dates**: Define the start and end dates for your metaverse if necessary.
* **Description**: Include a description of your metaverse.
* **Logo**: Upload a logo, which will be used in all transactional emails, and save the changes.
* **Cover photo**: Upload a cover photo, which will be visible on the metaverse dedicated page, and save the changes.

![Mext metaverse Dashboard Features Principal Information](/img/metaverse/principal-info.png)

> The description will be available on the website page, therefore make sure to add a clear description of your Metaverse activity and business. In the text, consider the SEO aspect to reference your Metaverse as much as possible by adding exactly the keywords you uses to reference your business on google, websites…
