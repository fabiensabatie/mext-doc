...
![](</img/Marva images/documentationt.jpg>)

1.    Provide a title for the meeting. 

2.    3. By default public but you can make it
private 

3.    4. Select the appropriate category for the
meeting “Avatar gathering (with Audio spatial)” 

4.    Determine whether
the meeting should be private (restricted to invited guests) or public (open to
all within the Metaverse). 

5.    6. Select an event if you want to make it
related to an event and/or added to an event program 

6.    Then press on add to create your avatars
gathering.
