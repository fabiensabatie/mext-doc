...
1.  
2. If your meeting is private, use the 'Add Guests'
        button to include your guest list. 
...
1.  
2. Employ the 'Envelop' button to send email
        invitations for your meeting.

11.   Utilize the '3 Squares' button to
access the Metabuilder and craft your 3D meeting space.  Here, you can:

-       Elevate your 3D space and tailor it to suit your
avatar gathering meeting.

-       Establish a dedicated 3D location within your 3D
interactive space and Metaverse, such as adding a building to host your avatar
gathering guests. Ensure you adjust the teleportation settings for the entry to
this specific space, ensuring that when your guests join the meeting, they are
seamlessly transported to the designated meeting space.

-       If you have a Professional subscription, allowing
multiple scenes, you even have the capability to construct an entire scene
exclusively dedicated to your avatar gathering meeting."

1.  
2. Click the green link button to copy the meeting
        link for sharing when needed.
