...
2.    By default, public but you can make it
private 

3.     Select the appropriate category for the
meeting

1.    Video meeting to be broadcasted for a live
session into the Metaverse 

2.    Standard Video meeting 

4.    Determine whether
the meeting should be private (restricted to invited guests) or public (open to
all within the Metaverse). 

5.    Select an event if you want to make it
related to an event and/or added to an event program 

Then press on add to create your meeting
