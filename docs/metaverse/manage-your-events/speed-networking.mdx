...
![](/img/Marvaimages/Documentationspeednetworkingx.jpg)

5\. Edit the created Speed Networking session by clicking the pencil icon.

6\. Utilize the 'Human Figure' icon button to view and monitor registered participants in your Speed Networking session.

![](/img/Marvaimages/documentationavatarmeetingsubscriber.jpg)

7\. Employ the arrow icon to send out the agenda again
