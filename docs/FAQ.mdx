...
**Begin by choosing your desired language**, then proceed to include a **category**, **question**, and its corresponding **answer**. Once added, this information will promptly appear for visitors in the **Support/Feedback button, located in the top menu within the Metaverse. **![](/img/Marvaimages/documentationsupportfaq1.jpg)
