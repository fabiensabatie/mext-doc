...
3-	When you add the name of the teleportation location and click on “Add New teleportation zone location”, you create it:
...
1\.	Furthermore, clicking on any element within the list will instantly locate it within your scene in the Metabuilder.
