...
You can obtain a comprehensive overview of your 3D immersive space and Metaverse statistics either by specific **time periods or for individual events**. To access the statistics for a particular partner space and booth, simply choose it from the booth selection menu under the statistics overview.
 ...
 ![](/img/Marvaimages/documentation1.jpg)

### **Visitors**

By clicking on **"Visitors,"** you can access a comprehensive list of your visitors, organized by time frame or event. Download the visitor list and associated data to create custom charts and analytics graphics tailored to your preferences.

![](/img/Marvaimages/Inspirationvisitorsa.jpg)

When you scroll down, you find a second section, you can access **visitor statistics** sorted by country, starting with the highest number of visitors by country. You have the **option to organize these statistics** based on either t**ime periods or specific events.**

### **Registrations **

 ![](</img/Marvaimages/documentation3 (1).jpg>)
...
### **Replays statistics **
 ...
 ![](/img/Marvaimages/documentation4.jpg)
...
### **Exhibitors**
 ...
 ![](/img/Marvaimages/documentation5.jpg)
